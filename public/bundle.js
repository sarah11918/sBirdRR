      ...
      (function() {
        ...
        function updateFunctionComponent(current2, workInProgress2, Component2, nextProps, renderExpirationTime2) {
          ...
          prepareToReadContext(workInProgress2, renderExpirationTime2);
          {
            ReactCurrentOwner$1.current = workInProgress2;
            setIsRendering(true);
            nextChildren = renderWithHooks(current2, workInProgress2, Component2, nextProps, context2, renderExpirationTime2);
            if (workInProgress2.mode & StrictMode) {
              if (workInProgress2.memoizedState !== null) {
                nextChildren = renderWithHooks(current2, workInProgress2, Component2, nextProps, context2, renderExpirationTime2);
              }
        ...
        function mountIndeterminateComponent(_current, workInProgress2, Component2, renderExpirationTime2) {
          ...
          var value;
          {
            ...
            setIsRendering(true);
            ReactCurrentOwner$1.current = workInProgress2;
            value = renderWithHooks(null, workInProgress2, Component2, props, context2, renderExpirationTime2);
            setIsRendering(false);
          }
          workInProgress2.effectTag |= PerformedWork;
...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  var Route = function(_React$Component) {
    ...
    _proto.render = function render2() {
      ...
      return react3.default.createElement(context.Consumer, null, function(context$1) {
        ...
        return react3.default.createElement(context.Provider, {
          value: props
        }, props.match ? children ? typeof children === "function" ? evalChildrenDev(children, props, _this.props.path) : children : component ? react3.default.createElement(component, props) : render3 ? render3(props) : null : typeof children === "function" ? evalChildrenDev(children, props, _this.props.path) : null);
      });
    };
    return Route2;
  }(react3.default.Component);
  ...
  var Switch = function(_React$Component) {
    ...
    _proto.render = function render2() {
      ...
      return react3.default.createElement(context.Consumer, null, function(context2) {
        ...
        var element, match;
        react3.default.Children.forEach(_this.props.children, function(child) {
          if (match == null && react3.default.isValidElement(child)) {
            element = child;
  ...
  var Link = forwardRef(function(_ref2, forwardedRef) {
    ...
    return react2.default.createElement(context.Consumer, null, function(context2) {
      ...
      return react2.default.createElement(component, props);
    });
  });
  if (true) {
  ...
  const SearchForm2 = (props) => {
    return react14.default.createElement(react14.default.Fragment, null, react14.default.createElement("h3", null, "Choose your eBird Region"), react14.default.createElement("form", {
      onSubmit: props.getSightings
    }, react14.default.createElement("select", {
      name: "location"
    }, react14.default.createElement("option", {
      value: "CA-PE-PR",
      selected: true
    }, "Prince County, PEI"), react14.default.createElement("option", {
      value: "CA-PE-QU"
    }, "Queens County, PEI"), react14.default.createElement("option", {
      value: "CA-PE-KI"
    }, "Kings County, PEI"), react14.default.createElement("option", {
      value: "CA-ON-DR"
    }, "Durham Region, ON"), react14.default.createElement("option", {
      value: "CA-ON-HT"
    }, "Halton Region, ON"), react14.default.createElement("option", {
      value: "CA-ON-OT"
    }, "Ottawa, ON"), react14.default.createElement("option", {
      value: "CA-ON-PL"
    }, "Peel Region, ON"), react14.default.createElement("option", {
      value: "CA-ON-SC"
    }, "Simcoe County, ON"), react14.default.createElement("option", {
      value: "CA-ON-TO"
    }, "Toronto, ON")), react14.default.createElement("button", {
      className: "select-button"
    }, "Find my bird!")), react14.default.createElement("h3", null, "(or enter your region ID below)"), react14.default.createElement("form", {
      onSubmit: props.getSightings,
      className: "search-form"
    }, react14.default.createElement("input", {
      name: "location",
      className: "user-input",
      type: "text",
      placeholder: "Location: e.g CA-PE-PR"
    }), react14.default.createElement("button", {
      className: "search-button"
    }, "Find my bird!")), react14.default.createElement("p", {
      className: "more-info"
    }, react14.default.createElement("a", {
  ...
  function Home2() {
    const [errorMessage, setErrorMessage] = react11.useState(false);
    const [bird, setBird] = react11.useState([{comName: "", locName: "", obsDt: ""}]);
    ...
    return react10.default.createElement(Container_default, null, react10.default.createElement("h1", null, "Home"), react10.default.createElement(SearchForm_default, {
      ...
      birdData: bird
    }), errorMessage && react10.default.createElement(ErrorMessage_default, null));
  }

  // src/Recent.js
  const react13 = __toModule(require_react());
  function Recent2() {
    return react13.default.createElement(react13.default.Fragment, null, react13.default.createElement("h1", null, "Recent"), react13.default.createElement("div", {
      id: "data-container"
    }));
  }
  ...
  function Notable2() {
    return react12.default.createElement(react12.default.Fragment, null, react12.default.createElement("h1", null, "Notable"), react12.default.createElement("div", {
      id: "data-container"
    }));
  }
  ...
  const App = () => {
    return React4.createElement("div", null, React4.createElement("nav", null, React4.createElement(Link, {
      to: "/"
    }, "Home"), React4.createElement(Link, {
      to: "/recent"
      ...
      exact: true,
      path: "/recent"
    }, React4.createElement(Recent_default, null)), React4.createElement(Route, {
      exact: true,
      path: "/notable"
    }, React4.createElement(Notable_default, null)), React4.createElement(Route, {
      exact: true,
      path: "/backyard"
