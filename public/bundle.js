...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  function RecentBirdList2(props) {
  ...
  function Recent2() {
    const [recentBirds, setRecentBirds] = react17.useState([{comName: ""}]);
    ...
    }, "Get the list of recent birds"), react16.default.createElement(RecentBirdList2, {
      birdList: recentBirds
    }));
  }
  ...
  const App = () => {
    return React4.createElement("div", null, React4.createElement("nav", null, React4.createElement(Link, {
      ...
      exact: true,
      path: "/recent"
    }, React4.createElement(Recent2, null)), React4.createElement(Route, {
      exact: true,
      path: "/notable"
